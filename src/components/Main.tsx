...
export default function Main() {
  ...
  return (
    <>
      <div>
        <Form onInputChange={onInputChange} handleSubmit={handleSubmit} addingContact={addContact.status} />
      </div>
          ...
          data?.map((contact) => (
            ...
            >
              ...
              <div className="flex gap-2 mt-2">
                <button className="py-1 px-6 bg-red-400 text-white text-xs font-semibold" onClick={() => handleDelete(contact.id)}>
                  Delete
                </button>
              </div>
            </div>
